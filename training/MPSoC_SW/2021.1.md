...
Before build petalinux project (step 3) call

`nano $TRAINING_PATH/QEMU_Linux_dbg/lab/petalnx_proj/project-spec/meta-user/recipes-bsp/device-tree/files/system-user.dtsi`
...
Instead comment line, rewrite it to `return XST_SUCCESS;`
